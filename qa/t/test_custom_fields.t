...
screenshot_page($sel, "/app/artifacts/new_bugmail1.png");
$sel->click_ok("new_bugmail");
screenshot_page($sel, "/app/artifacts/new_bugmail2.png");
$sel->value_is("new_bugmail", "on");
screenshot_page($sel, "/app/artifacts/new_bugmail3.png");
$sel->value_is("obsolete", "off");
$sel->click_ok("create");
$sel->wait_for_page_to_load_ok(WAIT_TIME);
$sel->title_is("Custom Field Created");
